...
var InterpolateHtmlPlugin = require('@mirego/react-dev-utils/InterpolateHtmlPlugin');
...
```js
var path = require('path');
var ModuleScopePlugin = require('@mirego/react-dev-utils/ModuleScopePlugin');
...
```js
var path = require('path');
var WatchMissingNodeModulesPlugin = require('@mirego/react-dev-utils/WatchMissingNodeModulesPlugin');
...
```js
var path = require('path');
var checkRequiredFiles = require('@mirego/react-dev-utils/checkRequiredFiles');
...
```js
var clearConsole = require('@mirego/react-dev-utils/clearConsole');
...
```js
const eslintFormatter = require('@mirego/react-dev-utils/eslintFormatter');
...
} = require('@mirego/react-dev-utils/FileSizeReporter');
...
var formatWebpackMessages = require('@mirego/react-dev-utils/formatWebpackMessages');
...
```
  const printBuildError = require('@mirego/react-dev-utils/printBuildError')
  try {
    build()
  } catch(e) {
...
```js
var getProcessForPort = require('@mirego/react-dev-utils/getProcessForPort');
...
```js
var path = require('path');
var openBrowser = require('@mirego/react-dev-utils/openBrowser');
